...
UIBezierPath *trajMarkerPath(UIColor *fillColor) {
    ...
    [bezierPath addCurveToPoint: CGPointMake(7.97, 19.66)
                  controlPoint1: CGPointMake(2.17, 19.71)
                  controlPoint2: CGPointMake(4.91, 19.66)];
    
    [bezierPath addCurveToPoint: CGPointMake(15.95, 19.78)
                  controlPoint1: CGPointMake(11.03, 19.66)
                  controlPoint2: CGPointMake(13.77, 19.71)];
